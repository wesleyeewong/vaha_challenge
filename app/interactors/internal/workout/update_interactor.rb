...
class Internal::Workout::UpdateInteractor
  ...
  def initialize(trainer, workout_id, workout_params)
    @trainer = trainer
  ...
  def call
    ...
    Workout.transaction do
      ...
      @workout.workout_exercises.delete_all
      @workout.update!(slug: workout_slug, state: workout_state)
  ...
  attr_reader :workout_params, :exercise_slugs, :workout_slug, :durations, :workout_id

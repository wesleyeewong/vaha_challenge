...
RSpec.describe Internal::Workout::CreateInteractor do
  ...
  let(:interactor) { described_class.new(trainer, workout_params) }
  ...
  describe "#call" do
    it "creates workout with the specified params" do
